...
class InventoryView(View):
    ...
    def update_view(self):
        ...
        try:
            ...
            sorted_inventory = sorted(inventory, key=lambda x: (x['rarity'], x['item']), reverse=True)
            ...
            logging.error(f"Error in update_view: {e}", exc_info=True)

    # Button callbacks with added logging
